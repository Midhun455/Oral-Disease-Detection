...
!(function (e, t) {
  ...
  var s,
    ...
    _ =
      ...
      {
        set: function (e, t, i) {
          void 0 === e.bsKey && ((e.bsKey = { key: t, id: r }), r++),
            (s[e.bsKey.id] = i);
        },
        get: function (e, t) {
        ...
        delete: function (e, t) {
          if (void 0 !== e.bsKey) {
            var i = e.bsKey;
            i.key === t && (delete s[i.id], delete e.bsKey);
          }
        },
      }),
    x = function (e, t, i) {
  ...
  function P(e, t, i) {
    var n = "string" == typeof t,
      ...
      r = e.replace(T, ""),
      o = D[r];
    return o && (r = o), O.has(r) || (r = e), [n, s, r];
  }
  function z(e, t, i, n, s) {
    if ("string" == typeof t && e) {
      ...
      if (u) u.oneOff = u.oneOff && s;
        ...
        var p = I(a, t.replace(E, "")),
          h = o
            ? (function (e, t, i) {
                return function n(s) {
                  for (
                    var r = e.querySelectorAll(t), o = s.target;
                    o && o !== this;
                    o = o.parentNode
                  )
        ...
        if ("string" == typeof t && e) {
          ...
          if (void 0 === o) {
              ...
              Object.keys(d).forEach(function (i) {
                !(function (e, t, i, n) {
                  ...
                  Object.keys(s).forEach(function (r) {
                    if (r.includes(n)) {
                      var o = s[r];
                      W(e, t, i, o.originalHandler, o.delegationSelector);
                    }
                  });
                })(e, d, i, t.slice(1));
              });
            ...
            Object.keys(u).forEach(function (i) {
              ...
              if (!l || t.includes(n)) {
                var s = u[i];
                W(e, d, a, s.originalHandler, s.delegationSelector);
              }
            });
          } else {
            if (!d || !d[a]) return;
      ...
      trigger: function (e, t, i) {
        ...
        return (
          o &&
            ...
            (d = !n.isImmediatePropagationStopped()),
            (c = n.isDefaultPrevented())),
          a
            ? (u = document.createEvent("HTMLEvents")).initEvent(r, l, !0)
      ...
      return (
        ...
        (s._removeElement = function (e) {
          ...
          if ((e.classList.remove("show"), e.classList.contains("fade"))) {
            var i = c(e);
            j.one(e, "transitionend", function () {
        ...
        (s._destroyElement = function (e) {
          e.parentNode && e.parentNode.removeChild(e),
            j.trigger(e, "closed.bs.alert");
        }),
        (i.jQueryInterface = function (e) {
          return this.each(function () {
            var t = S(this, "bs.alert");
  ...
  j.on(
    ...
    b(function () {
      ...
      if (e) {
        var t = e.fn.button;
        (e.fn.button = B.jQueryInterface),
          (e.fn.button.Constructor = B),
          (e.fn.button.noConflict = function () {
            return (e.fn.button = t), B.jQueryInterface;
          });
      }
    });
  var q = {
      ...
      getDataAttribute: function (e, t) {
        return Y(e.getAttribute("data-bs-" + R(t)));
      },
      offset: function (e) {
    ...
    G = {
      ...
      parents: function (e, t) {
        for (
          ...
          this.matches(n, t) && i.push(n), (n = n.parentNode);
        return i;
      },
      prev: function (e, t) {
    ...
    J = (function (e) {
      function s(t, i) {
        ...
        return (
          ...
          (n._indicatorsElement = G.findOne(
            ".carousel-indicators",
            n._element
          )),
          (n._touchSupported =
      ...
      return (
        ...
        (r._addEventListeners = function () {
          ...
          this._config.keyboard &&
            j.on(this._element, "keydown.bs.carousel", function (t) {
              return e._keydown(t);
            }),
            "hover" === this._config.pause &&
              (j.on(this._element, "mouseenter.bs.carousel", function (t) {
                return e.pause(t);
              }),
        ...
        (r._addTouchEventListeners = function () {
          ...
          G.find(".carousel-item img", this._element).forEach(function (e) {
            ...
            this._pointerEvent
              ? (j.on(this._element, "pointerdown.bs.carousel", function (e) {
                  return t(e);
                }),
                j.on(this._element, "pointerup.bs.carousel", function (e) {
                  return i(e);
                }),
                this._element.classList.add("pointer-event"))
              : (j.on(this._element, "touchstart.bs.carousel", function (e) {
                  return t(e);
                }),
                ...
                j.on(this._element, "touchend.bs.carousel", function (e) {
                  return i(e);
                }));
        }),
        ...
        (r._triggerSlideEvent = function (e, t) {
          var i = this._getItemIndex(e),
            n = this._getItemIndex(
              G.findOne(".active.carousel-item", this._element)
            );
        ...
        (r._setActiveIndicatorElement = function (e) {
          if (this._indicatorsElement) {
            for (
              var t = G.find(".active", this._indicatorsElement), i = 0;
              i < t.length;
              i++
            )
        ...
        (r._slide = function (e, t) {
          var i,
            ...
            s,
            r = this,
            o = G.findOne(".active.carousel-item", this._element),
          ...
          if (
            ...
            if (
              ...
              l.classList.add(n), v(l), o.classList.add(i), l.classList.add(i);
              var p = c(o);
              j.one(o, "transitionend", function () {
                l.classList.remove(i, n),
                  l.classList.add("active"),
                  o.classList.remove("active", n, i),
                  (r._isSliding = !1),
                  setTimeout(function () {
                    j.trigger(r._element, "slid.bs.carousel", {
                      relatedTarget: l,
                      direction: s,
                      from: a,
                      to: d,
        ...
        (s.carouselInterface = function (e, t) {
          var n = S(e, "bs.carousel"),
            r = i({}, $, q.getDataAttributes(e));
          "object" == typeof t && (r = i({}, r, t));
          var o = "string" == typeof t ? t : r.slide;
          if ((n || (n = new s(e, r)), "number" == typeof t)) n.to(t);
  ...
  j.on(
    ...
    j.on(window, "load.bs.carousel.data-api", function () {
      for (
        var e = G.find('[data-bs-ride="carousel"]'), t = 0, i = e.length;
        t < i;
        t++
      )
        J.carouselInterface(e[t], S(e[t], "bs.carousel"));
    }),
    b(function () {
      var e = y();
      if (e) {
        var t = e.fn[V];
        (e.fn[V] = J.jQueryInterface),
          (e.fn[V].Constructor = J),
          (e.fn[V].noConflict = function () {
            return (e.fn[V] = t), J.jQueryInterface;
          });
      }
    });
  var Q = "collapse",
    ...
    ee = (function (e) {
      function s(t, i) {
        ...
        for (
          var s = G.find('[data-bs-toggle="collapse"]'), r = 0, o = s.length;
          r < o;
          r++
        ) {
          var a = s[r],
            d = l(a),
            c = G.find(d).filter(function (e) {
              return e === t;
            });
          null !== d &&
            c.length &&
            ((n._selector = d), n._triggerArray.push(a));
        }
        return (
      ...
      return (
        ...
        (r.show = function () {
          ...
          if (
            ...
            this._parent &&
              0 ===
                (t = G.find(".show, .collapsing", this._parent).filter(
                  function (t) {
            ...
            if (t) {
              ...
              if ((i = r ? S(r, "bs.collapse") : null) && i._isTransitioning)
                return;
            }
            if (
              !j.trigger(this._element, "show.bs.collapse").defaultPrevented
            ) {
              t &&
                t.forEach(function (e) {
                  n !== e && s.collapseInterface(e, "hide"),
                    i || x(e, "bs.collapse", null);
                });
        ...
        (r.hide = function () {
          ...
          if (
            !this._isTransitioning &&
            this._element.classList.contains("show") &&
            !j.trigger(this._element, "hide.bs.collapse").defaultPrevented
          ) {
        ...
        (r._getConfig = function (e) {
          return ((e = i({}, K, e)).toggle = Boolean(e.toggle)), f(Q, e, Z), e;
        }),
  ...
  j.on(
    ...
    b(function () {
      ...
      if (e) {
        var t = e.fn[Q];
        (e.fn[Q] = ee.jQueryInterface),
          (e.fn[Q].Constructor = ee),
  ...
  function be(e) {
    return (
      (ue(e) ? e.ownerDocument : e.document) || window.document
    ).documentElement;
  }
  function we(e) {
    return "html" === de(e)
      ? e
      : e.assignedSlot || e.parentNode || e.host || be(e);
  }
  function _e(e) {
  ...
  function xe(e) {
    for (var t = ce(e), i = _e(e); i && ye(i) && "static" === ve(i).position; )
      i = _e(i);
  ...
  var Ce = {
      ...
      fn: function (e) {
        var t,
          ...
          o = fe(i.placement),
          a = Se(o),
          l = [se, ne].indexOf(o) >= 0 ? "height" : "width";
        if (s && r) {
          var d = i.modifiersData[n + "#persistent"].padding,
            ...
            _ = Ee(y, w, b),
            x = a;
          i.modifiersData[n] = (((t = {})[x] = _), (t.centerOffset = _ - w), t);
        }
      },
      effect: function (e) {
        var t = e.state,
        ...
        null != r &&
          ...
          (t.modifiersData[n + "#persistent"] = {
            padding: Te("number" != typeof a ? a : Me(a, re)),
          }));
      },
      requires: ["popperOffsets"],
      requiresIfExists: ["preventOverflow"],
    },
    ke = { top: "auto", right: "auto", bottom: "auto", left: "auto" };
  function De(e) {
    var t,
      i = e.popper,
      n = e.popperRect,
    ...
    if (l) {
      ...
      v === ce(i) && (v = be(i)),
        s === te &&
          ((m = ie), (u -= v.clientHeight - n.height), (u *= a ? 1 : -1)),
        s === se &&
          ((f = ne), (c -= v.clientWidth - n.width), (c *= a ? 1 : -1));
    }
    var y,
      b = Object.assign({ position: o }, l && ke);
    return a
      ? Object.assign(
          Object.assign({}, b),
          {},
  ...
  function He(e) {
    return je(be(e)).left + Ne(e).scrollLeft;
  }
  function Fe(e) {
    var t = ve(e),
      i = t.overflow,
  ...
  function Be(e, t) {
    ...
    var i = (function e(t) {
      ...
      n = "body" === de(i),
      s = ce(i),
      r = n ? [s].concat(s.visualViewport || [], Fe(i) ? i : []) : i,
      o = t.concat(r);
    return n ? o : o.concat(Be(we(r)));
  }
  function Ye(e) {
    return Object.assign(
      Object.assign({}, e),
      ...
      : Ye(
          (function (e) {
            var t = be(e),
              ...
              a = -i.scrollTop;
            return (
              "rtl" === ve(n || t).direction &&
                (o += Math.max(t.clientWidth, n ? n.clientWidth : 0) - s),
              { width: s, height: r, x: o, y: a }
            );
          })(be(e))
        );
  }
  ...
  function Ve(e, t) {
    ...
    var i = t,
      ...
      h = i.padding,
      f = void 0 === h ? 0 : h,
      m = Te("number" != typeof f ? f : Me(f, re)),
        ...
        var n =
            "clippingParents" === t
              ? (function (e) {
                  var t = Be(we(e)),
                    i =
                      ["absolute", "fixed"].indexOf(ve(e).position) >= 0 &&
                      pe(e)
                        ? xe(e)
                        : e;
                  return ue(i)
      ...
      })(ue(b) ? b : b.contextElement || be(e.elements.popper), o, l),
      _ = je(v),
      x = Ge({ reference: _, element: y, strategy: "absolute", placement: s }),
      S = Ye(Object.assign(Object.assign({}, y), x)),
      E = "popper" === c ? S : _,
      T = {
            ...
            return (
              (e[i] = (function (e, t, i) {
                ...
                return (
                  (o = o || 0),
                  (a = (a || 0) * s),
                  [se, ne].indexOf(n) >= 0 ? { x: a, y: o } : { x: o, y: a }
                );
              })(i, t.rects, r)),
              e
            );
        ...
        if (x) {
          if (r) {
            var C = "y" === w ? te : se,
              ...
              F = N[k],
              B = Ee(0, S[D], j[D]),
              Y = b ? S[D] / 2 - A - B - H - T : P - B - H - T,
              R = b ? -S[D] / 2 + A + B + F + T : z + B + F + T,
              q = t.elements.arrow && xe(t.elements.arrow),
              ...
              $ = x[w] + Y - V - G,
              X = x[w] + R - V,
              U = Ee(h ? Math.min(I, $) : I, O, h ? Math.max(L, X) : L);
            (x[w] = U), (M[w] = U - O);
          }
          if (a) {
            var J = "x" === w ? te : se,
        ...
        (("body" !== de(t) || Fe(r)) &&
          (l =
            (n = t) !== ce(n) && pe(n)
              ...
              : Ne(n)),
        pe(t)
          ? (((d = je(t)).x += t.clientLeft), (d.y += t.clientTop))
          : r && (d.x = He(r))),
      {
            ...
            return (
              ...
              a.orderedModifiers.forEach(function (e) {
                ...
                if ("function" == typeof s) {
                  var r = s({ state: a, name: t, instance: c, options: n });
                  l.push(r || function () {});
                }
              }),
              c.update()
              ...
              if (it(t, i)) {
                ...
                for (var n = 0; n < a.orderedModifiers.length; n++)
                  if (!0 !== a.reset) {
                    ...
                    "function" == typeof r &&
                      (a =
                        r({ state: a, options: l, name: u, instance: c }) || a);
                  } else (a.reset = !1), (n = -1);
              }
            }
          },
  ...
  var st = nt(),
    rt = nt({ defaultModifiers: [Le, Ke, Oe, he] }),
    ot = nt({ defaultModifiers: [Le, Ke, Oe, he, Qe, $e, Ze, Ce, Je] }),
    at = Object.freeze({
      __proto__: null,
      popperGenerator: nt,
      detectOverflow: Ve,
    ...
    ct = w ? "top-end" : "top-start",
    ut = w ? "top-start" : "top-end",
    pt = w ? "bottom-end" : "bottom-start",
    ht = w ? "bottom-start" : "bottom-end",
    ...
    yt = (function (e) {
      function s(t, i) {
        var n;
        return (
          ((n = e.call(this, t) || this)._popper = null),
          (n._config = n._getConfig(i)),
      ...
      return (
            ...
            if (
              ...
              "ontouchstart" in document.documentElement &&
                ...
                (n = []).concat
                  ...
                  .forEach(function (e) {
                    return j.on(e, "mouseover", null, function () {});
                  }),
                this._element.focus(),
                this._element.setAttribute("aria-expanded", !0),
                this._menu.classList.toggle("show"),
                this._element.classList.toggle("show"),
                j.trigger(e, "shown.bs.dropdown", t);
            }
          }
        }),
        (r.hide = function () {
          if (
            ...
            var e = s.getParentFromElement(this._element),
              t = { relatedTarget: this._element };
            j.trigger(e, "hide.bs.dropdown", t).defaultPrevented ||
              (this._popper && this._popper.destroy(),
              this._menu.classList.toggle("show"),
              this._element.classList.toggle("show"),
              j.trigger(e, "hidden.bs.dropdown", t));
          }
        }),
        (r.dispose = function () {
          e.prototype.dispose.call(this),
        ...
        (r._getPlacement = function () {
          ...
          var t =
            ...
            getComputedStyle(this._menu)
              ...
              .trim();
          return e.classList.contains("dropup") ? (t ? ut : ct) : t ? ht : pt;
        }),
        ...
        (s.dropdownInterface = function (e, t) {
          var i = S(e, "bs.dropdown");
          if (
            (i || (i = new s(e, "object" == typeof t ? t : null)),
            "string" == typeof t)
          ) {
            if (void 0 === i[t])
              throw new TypeError('No method named "' + t + '"');
        ...
        (s.clearMenus = function (e) {
          if (!e || (2 !== e.button && ("keyup" !== e.type || "Tab" === e.key)))
            for (
              var t = G.find('[data-bs-toggle="dropdown"]'),
                i = 0,
                n = t.length;
              i < n;
              i++
                ...
                if (
                  ...
                  !(
                    (e &&
                      ...
                      d.contains(e.target)) ||
                    j.trigger(r, "hide.bs.dropdown", a).defaultPrevented
                  )
                )
                  "ontouchstart" in document.documentElement &&
                    (l = []).concat
            ...
            if ("Escape" === e.key)
              return (
                (this.matches('[data-bs-toggle="dropdown"]')
                  ? this
                  : G.prev(this, '[data-bs-toggle="dropdown"]')[0]
                ).focus(),
                void s.clearMenus()
              );
            if (i && "Space" !== e.key) {
  ...
  j.on(
    ...
    j.on(document, "click.bs.dropdown.data-api", yt.clearMenus),
    j.on(document, "keyup.bs.dropdown.data-api", yt.clearMenus),
    j.on(
      document,
    ...
    _t = (function (e) {
      function s(t, i) {
        ...
        return (
          ...
          (n._dialog = G.findOne(".modal-dialog", t)),
          (n._backdrop = null),
          (n._isShown = !1),
      ...
      return (
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            this._isShown ||
              ...
              j.on(this._dialog, "mousedown.dismiss.bs.modal", function () {
                j.one(t._element, "mouseup.dismiss.bs.modal", function (e) {
        ...
        (r.hide = function (e) {
          ...
          if (
            ...
            if (
              ...
              j.one(this._element, "transitionend", function (e) {
        ...
        (r._showElement = function (e) {
          ...
          var s = function () {
            t._config.focus && t._element.focus(),
              ...
              j.trigger(t._element, "shown.bs.modal", { relatedTarget: e });
          };
          if (i) {
            var r = c(this._dialog);
            j.one(this._dialog, "transitionend", s), h(this._dialog, r);
          } else s();
        }),
        ...
        (r._setEscapeEvent = function () {
          var e = this;
          this._isShown
            ? j.on(this._element, "keydown.dismiss.bs.modal", function (t) {
        ...
        (r._showBackdrop = function (e) {
          ...
          if (this._isShown && this._config.backdrop) {
            if (
              ...
              j.on(this._element, "click.dismiss.bs.modal", function (e) {
            ...
            j.one(this._backdrop, "transitionend", e), h(this._backdrop, n);
            ...
            if (this._element.classList.contains("fade")) {
              ...
              j.one(this._backdrop, "transitionend", s), h(this._backdrop, r);
            } else s();
          } else e();
        }),
            ...
            j.off(this._element, "transitionend"),
              j.one(this._element, "transitionend", function () {
                e._element.classList.remove("modal-static"),
                  t ||
                    (j.one(e._element, "transitionend", function () {
        ...
        (r._resetScrollbar = function () {
          G.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach(
            function (e) {
              ...
              void 0 !== t &&
                (q.removeDataAttribute(e, "padding-right"),
            ...
            G.find(".sticky-top").forEach(function (e) {
              ...
              void 0 !== t &&
                (q.removeDataAttribute(e, "margin-right"),
        ...
        (s.jQueryInterface = function (e, t) {
          return this.each(function () {
            ...
            if ((n || (n = new s(this, r)), "string" == typeof e)) {
              if (void 0 === n[e])
  ...
  j.on(
    ...
    b(function () {
      ...
      if (e) {
        var t = e.fn.modal;
        (e.fn.modal = _t.jQueryInterface),
          (e.fn.modal.Constructor = _t),
          (e.fn.modal.noConflict = function () {
            return (e.fn.modal = t), _t.jQueryInterface;
          });
      }
    });
  var xt = new Set([
  ...
  function Tt(e, t, i) {
    ...
    for (
      var s = new window.DOMParser().parseFromString(e, "text/html"),
        r = Object.keys(t),
        o = (n = []).concat.apply(n, s.body.querySelectorAll("*")),
        a = function (e, i) {
          var n,
            s = o[e],
            a = s.nodeName.toLowerCase();
          if (!r.includes(a)) return s.parentNode.removeChild(s), "continue";
          ...
          l.forEach(function (e) {
            (function (e, t) {
              ...
              if (t.includes(i))
                return (
                  !xt.has(i) ||
                  Boolean(e.nodeValue.match(St) || e.nodeValue.match(Et))
                );
              for (
              ...
              return !1;
            })(e, d) || s.removeAttribute(e.nodeName);
          });
        },
        l = 0,
        d = o.length;
  ...
  var Mt = "tooltip",
    ...
    At = (function (e) {
      function s(t, i) {
        ...
        return (
          ((n = e.call(this, t) || this)._isEnabled = !0),
          (n._timeout = 0),
          (n._hoverState = ""),
          (n._activeTrigger = {}),
          (n._popper = null),
      ...
      return (
          ...
          if (this._isEnabled)
            if (e) {
              var t = this.constructor.DATA_KEY,
                i = S(e.delegateTarget, t);
              i ||
                ((i = new this.constructor(
                  e.delegateTarget,
                  this._getDelegateConfig()
                )),
                x(e.delegateTarget, t, i)),
        ...
        (r.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            x(s, this.constructor.DATA_KEY, this),
            ...
            f && (u = s.classList).add.apply(u, f.split(" ")),
              "ontouchstart" in document.documentElement &&
                (p = []).concat
                  ...
                  .forEach(function (e) {
                    j.on(e, "mouseover", function () {});
                  });
            var m = function () {
              var t = e._hoverState;
              (e._hoverState = null),
                j.trigger(e._element, e.constructor.Event.SHOWN),
                "out" === t && e._leave(null, e);
            };
            if (this.tip.classList.contains("fade")) {
              var g = c(this.tip);
              j.one(this.tip, "transitionend", m), h(this.tip, g);
            } else m();
          }
        }),
        (r.hide = function () {
            ...
            var t = this.getTipElement(),
              i = function () {
                "show" !== e._hoverState &&
                  ...
                  j.trigger(e._element, e.constructor.Event.HIDDEN),
        ...
        (r._getContainer = function () {
          return !1 === this.config.container
            ...
            : G.findOne(this.config.container);
        }),
        ...
        (r._setListeners = function () {
          ...
          this.config.trigger.split(" ").forEach(function (t) {
            if ("click" === t)
              ...
              j.on(e._element, i, e.config.selector, function (t) {
                return e._enter(t);
              }),
                j.on(e._element, n, e.config.selector, function (t) {
                  return e._leave(t);
                });
            }
          }),
        ...
        (r._enter = function (e, t) {
          ...
          (t = t || S(e.delegateTarget, i)) ||
            ((t = new this.constructor(
              e.delegateTarget,
              this._getDelegateConfig()
            )),
            x(e.delegateTarget, i, t)),
            e &&
        ...
        (r._getConfig = function (e) {
          ...
          return (
            ...
            f(Mt, e, this.constructor.DefaultType),
            e.sanitize &&
              (e.template = Tt(e.template, e.allowList, e.sanitizeFn)),
            e
          );
        }),
        ...
        (r._cleanTipClass = function () {
          var e = this.getTipElement(),
            t = e.getAttribute("class").match(Ct);
          null !== t &&
            t.length > 0 &&
            t
              .map(function (e) {
        ...
        (s.jQueryInterface = function (e) {
          return this.each(function () {
            var t = S(this, "bs.tooltip"),
              i = "object" == typeof e && e;
            if (
              (t || !/dispose|hide/.test(e)) &&
              (t || (t = new s(this, i)), "string" == typeof e)
            ) {
              if (void 0 === t[e])
                throw new TypeError('No method named "' + e + '"');
              t[e]();
  ...
  b(function () {
    ...
    if (e) {
      var t = e.fn[Mt];
      (e.fn[Mt] = At.jQueryInterface),
        (e.fn[Mt].Constructor = At),
        (e.fn[Mt].noConflict = function () {
          return (e.fn[Mt] = t), At.jQueryInterface;
        });
    }
  });
  var Pt = "popover",
    ...
    jt = i({}, At.DefaultType, { content: "(string|element|function)" }),
    Nt = {
    ...
    Ht = (function (e) {
      ...
      return (
        ...
        (s.setContent = function () {
          var e = this.getTipElement();
          this.setElementContent(
            G.findOne(".popover-header", e),
            this.getTitle()
          );
          var t = this._getContent();
          "function" == typeof t && (t = t.call(this._element)),
            this.setElementContent(G.findOne(".popover-body", e), t),
            e.classList.remove("fade", "show");
        }),
        ...
        (i.jQueryInterface = function (e) {
          return this.each(function () {
            var t = S(this, "bs.popover"),
              n = "object" == typeof e ? e : null;
            if (
              (t || !/dispose|hide/.test(e)) &&
              (t || ((t = new i(this, n)), x(this, "bs.popover", t)),
              "string" == typeof e)
            ) {
              if (void 0 === t[e])
                throw new TypeError('No method named "' + e + '"');
  ...
  b(function () {
    ...
    if (e) {
      var t = e.fn[Pt];
      (e.fn[Pt] = Ht.jQueryInterface),
        (e.fn[Pt].Constructor = Ht),
        (e.fn[Pt].noConflict = function () {
          return (e.fn[Pt] = t), Ht.jQueryInterface;
        });
    }
  });
  var Ft = "scrollspy",
    ...
    Rt = (function (e) {
      function s(t, i) {
        var n;
        return (
          ((n = e.call(this, t) || this)._scrollElement =
          ...
          (n._scrollHeight = 0),
          j.on(n._scrollElement, "scroll.bs.scrollspy", function (e) {
            return n._process(e);
          }),
          n.refresh(),
          n._process(),
      ...
      return (
        (r.refresh = function () {
          ...
          (this._offsets = []),
            ...
            G.find(this._selector)
              .map(function (e) {
                var t = l(e),
                  s = t ? G.findOne(t) : null;
                if (s) {
                  var r = s.getBoundingClientRect();
                  if (r.width || r.height) return [q[i](s).top + n, t];
                }
                return null;
              })
              .filter(function (e) {
        ...
        (r._getConfig = function (e) {
          if (
            "string" !=
              typeof (e = i({}, Bt, "object" == typeof e && e ? e : {}))
                .target &&
            p(e.target)
          ) {
            var t = e.target.id;
            t || ((t = o(Ft)), (e.target.id = t)), (e.target = "#" + t);
          }
          return f(Ft, e, Yt), e;
        }),
        ...
        (r._activate = function (e) {
          ...
          i.classList.contains("dropdown-item")
            ...
            : (i.classList.add("active"),
              G.parents(i, ".nav, .list-group").forEach(function (e) {
        ...
        (s.jQueryInterface = function (e) {
          return this.each(function () {
            var t = S(this, "bs.scrollspy");
            if (
              (t || (t = new s(this, "object" == typeof e && e)),
              "string" == typeof e)
            ) {
              if (void 0 === t[e])
                throw new TypeError('No method named "' + e + '"');
  ...
  j.on(window, "load.bs.scrollspy.data-api", function () {
    G.find('[data-bs-spy="scroll"]').forEach(function (e) {
      return new Rt(e, q.getDataAttributes(e));
    });
  }),
    b(function () {
      var e = y();
      if (e) {
        var t = e.fn[Ft];
        (e.fn[Ft] = Rt.jQueryInterface),
          (e.fn[Ft].Constructor = Rt),
          (e.fn[Ft].noConflict = function () {
            return (e.fn[Ft] = t), Rt.jQueryInterface;
          });
      }
    });
  var qt = (function (e) {
    ...
    return (
          ...
          if (n) {
            var s =
              "UL" === n.nodeName || "OL" === n.nodeName
                ? ":scope > li > .active"
                : ".active";
            t = (t = G.find(s, n))[t.length - 1];
          }
          var r = null;
          if (
            (t &&
              (r = j.trigger(t, "hide.bs.tab", {
            ...
            var o = function () {
              j.trigger(t, "hidden.bs.tab", { relatedTarget: e._element }),
                j.trigger(e._element, "shown.bs.tab", { relatedTarget: t });
            };
      ...
      (s._activate = function (e, t, i) {
        ...
        if (s && r) {
          var a = c(s);
          s.classList.remove("show"), j.one(s, "transitionend", o), h(s, a);
        } else o();
      }),
      (s._transitionComplete = function (e, t, i) {
        ...
        e.classList.add("active"),
          ...
          e.parentNode &&
            ...
            (e.closest(".dropdown") &&
              G.find(".dropdown-toggle").forEach(function (e) {
                return e.classList.add("active");
              }),
            e.setAttribute("aria-expanded", !0)),
          i && i();
      ...
      (i.jQueryInterface = function (e) {
        return this.each(function () {
          var t = S(this, "bs.tab") || new i(this);
          if ("string" == typeof e) {
            if (void 0 === t[e])
              throw new TypeError('No method named "' + e + '"');
            t[e]();
  ...
  j.on(
    ...
    function (e) {
      e.preventDefault(), (S(this, "bs.tab") || new qt(this)).show();
    }
  ),
    b(function () {
      var e = y();
      if (e) {
        ...
        (e.fn.tab = qt.jQueryInterface),
          ...
          (e.fn.tab.noConflict = function () {
            return (e.fn.tab = t), qt.jQueryInterface;
          });
      }
    });
  var Gt = { animation: "boolean", autohide: "boolean", delay: "number" },
        ...
        (r.show = function () {
          ...
          if (!j.trigger(this._element, "show.bs.toast").defaultPrevented) {
            ...
            if (
              ...
              j.one(this._element, "transitionend", t), h(this._element, i);
            } else t();
          }
        }),
        (r.hide = function () {
  ...
  return (
    b(function () {
      ...
      if (e) {
        var t = e.fn.toast;
        (e.fn.toast = $t.jQueryInterface),
          (e.fn.toast.Constructor = $t),
          (e.fn.toast.noConflict = function () {
            return (e.fn.toast = t), $t.jQueryInterface;
          });
      }
    }),
    {
  ...
  (function (e, t) {
    ...
    return (
      ...
      (n.makeJQueryPlugin = function (t) {
        (t = t || e.jQuery) &&
          ((o = t).fn.imagesLoaded = function (e, t) {
  ...
  (function (e, t) {
    ...
    return function n(a) {
      if (
        ...
        for (
          var c = (d.isBorderBox = "border-box" == l.boxSizing), u = 0;
          u < r;
          u++
        ) {
          var p = s[u],
        ...
        var S = e(l.height);
        return (
          !1 !== S && (d.height = S + (_ ? 0 : g + w)),
          (d.innerWidth = d.width - (m + b)),
          (d.innerHeight = d.height - (g + w)),
    ...
    return (
      (i.htmlInit = function (t, n) {
        i.docReady(function () {
          ...
          d.forEach(function (e) {
            var i,
              r = e.getAttribute(o) || e.getAttribute(c);
            try {
              i = r && JSON.parse(r);
            } catch (i) {
              return void (
                s &&
                s.error("Error parsing " + o + " on " + e.className + ": " + i)
              );
            }
            var a = new t(e, i);
            u && u.data(e, n, a);
  ...
  (function (e, t) {
    ...
    return (
      ...
      (i.create = function (e, t) {
        ...
        return (
          ((s.prototype = Object.create(n)).constructor = s),
          t && (s.options = t),
  ...
  (function (e, t) {
    ...
    return (
      ...
      (n._getHorizontalColPosition = function (e, t) {
        ...
        return (
          (this.horizontalColIndex = n ? i + e : this.horizontalColIndex),
  ...
  (function (e, t) {
    ...
    (c._create = function () {
      ...
      (c._filter = function (e) {
        ...
        t = t || "*";
        for (
          var i = [], n = [], s = [], r = this._getFilterTest(t), o = 0;
          o < e.length;
          o++
        ) {
          var a = e[o];
      ...
      (c.updateSortData = function (e) {
        var t;
        (t = e ? ((e = s.makeArray(e)), this.getItems(e)) : this.items),
          this._getSorters(),
  ...
  (function (e) {
    ...
    (e.cleanData =
      ...
      (e.widget = function (t, i, n) {
        ...
        return (
          ...
          (r.prototype = e.widget.extend(
            ...
            a,
            { constructor: r, namespace: l, widgetName: t, widgetFullName: d }
          )),
          s
      ...
      (e.widget.extend = function (t) {
        for (
          var i, s, r = n.call(arguments, 1), o = 0, a = r.length;
          o < a;
          o++
        )
          for (i in r[o])
        ...
        option: function (t, i) {
          ...
          if ("string" == typeof t)
            if (((o = {}), (t = (n = t.split(".")).shift()), n.length)) {
              for (
                s = o[t] = e.widget.extend({}, this.options[t]), r = 0;
                r < n.length - 1;
                r++
              )
                (s[n[r]] = s[n[r]] || {}), (s = s[n[r]]);
      ...
      e.each({ show: "fadeIn", hide: "fadeOut" }, function (t, i) {
        e.Widget.prototype["_" + t] = function (n, s, r) {
          ...
          "number" == typeof (s = s || {}) && (s = { duration: s }),
            ...
            o && e.effects && e.effects.effect[a]
              ? n[t](s)
              : a !== t && n[a]
    ...
    e(document).on("mouseup", function () {
      ...
      e.widget("ui.slider", e.ui.mouse, {
        ...
        _createHandles: function () {
          ...
          for (
            n.length > r && (n.slice(r).remove(), (n = n.slice(0, r))),
              t = n.length;
            t < r;
            t++
          )
        ...
        values: function (t, i) {
          ...
          for (n = this.options.values, s = t, r = 0; r < n.length; r += 1)
          ...
          this._hasMultipleValues()
            ? this.handles.each(function (n) {
                (i =
                  ...
                  (c["horizontal" === l.orientation ? "left" : "bottom"] =
                    i + "%"),
                  e(this).stop(1, 1)[d ? "animate" : "css"](c, a.animate),
                  !0 === l.options.range &&
            ...
            : ((n = this.value()),
              ...
              (c["horizontal" === this.orientation ? "left" : "bottom"] =
                i + "%"),
              this.handle.stop(1, 1)[d ? "animate" : "css"](c, a.animate),
              "min" === o &&
                "horizontal" === this.orientation &&
                this.range
                  .stop(1, 1)
                  [d ? "animate" : "css"]({ width: i + "%" }, a.animate),
              "max" === o &&
                "horizontal" === this.orientation &&
                this.range
                  .stop(1, 1)
                  [d ? "animate" : "css"]({ width: 100 - i + "%" }, a.animate),
              "min" === o &&
                "vertical" === this.orientation &&
                this.range
                  .stop(1, 1)
                  [d ? "animate" : "css"]({ height: i + "%" }, a.animate),
              "max" === o &&
                "vertical" === this.orientation &&
                this.range
                  .stop(1, 1)
      ...
      (t.prototype.handleScroll = function () {
        ...
        for (var i in t) {
          ...
          for (var r in this.waypoints[i]) {
            ...
            ((a && l) || (!a && !l)) &&
              (o.queueTrigger(s), (e[o.group.id] = o.group));
          }
        }
        ...
        (e = {
          ...
          for (var a in this.waypoints[r]) {
            ...
            p.element !== p.element.window &&
              (m = p.adapter.offset()[o.offsetProp]),
              "function" == typeof h
                ? (h = h.apply(p))
                : "string" == typeof h &&
                  ((h = parseFloat(h)),
                  p.options.offset.indexOf("%") > -1 &&
                    (h = Math.ceil((o.contextDimension * h) / 100))),
              ...
              (u = !d && !c),
              !g && d && c
                ? (p.queueTrigger(o.backward), (n[p.group.id] = p.group))
                : ((!g && u) || (g && o.oldScroll >= p.triggerPoint)) &&
                  (p.queueTrigger(o.forward), (n[p.group.id] = p.group));
          }
        }
        return (
          ...
          function (r) {
            !(function () {
              ...
              for (var h = o; h >= (s.beginAt / a) * o; h--) {
                var f = parseFloat((a / o) * h).toFixed(d);
                if (c) {
                  f = parseInt((i / o) * h);
              ...
              t.data("counterup-nums", r), t.text(s.beginAt);
    ...
    (e = function (e, t) {
      ...
      ((DateFormatter = function (e) {
        ...
        parseDate: function (t, i) {
          ...
          if ("U" === i) return (r = parseInt(t)) ? new Date(1e3 * r) : t;
          switch (typeof t) {
            case "number":
              return new Date(t);
            case "string":
          ...
          if (!(n = i.match(h.validParts)) || 0 === n.length)
            throw new Error("Invalid date format definition.");
          for (
            s = t.replace(h.separators, "\0").split("\0"), r = 0;
            r < s.length;
            r++
          )
            switch (((o = s[r]), (a = parseInt(o)), n[r])) {
              case "y":
              case "Y":
                if (!a) return null;
                (u = o.length),
                  (v.year = 2 === u ? parseInt((a < 70 ? "20" : "19") + o) : a),
                  (f = !0);
                break;
              case "m":
              case "n":
              ...
              case "F":
                if (isNaN(a)) {
                  if (!(0 < (l = h.getMonth(o)))) return null;
                  v.month = l;
                } else {
              ...
              case "h":
                if (
                  ...
                  (c = e(p, g.meridiem[0]) ? 0 : e(p, g.meridiem[1]) ? 12 : -1),
                    1 <= a && a <= 12 && -1 < c
                      ? (v.hour = a + c - 1)
                      : 0 <= a && a <= 23 && (v.hour = a);
                else {
        ...
        guessDate: function (e, t) {
          ...
          for (s = 0; s < l.length; s++) {
            if (((u = 2), (o = l[s]), (a = parseInt(o.substr(0, 2))), isNaN(a)))
              return null;
            switch (s) {
              case 0:
              ...
              case 2:
                if (
                  ...
                  (u = (i = o.length) < 4 ? i : 4),
                  !(n = parseInt(
                    i < 4 ? n.toString().substr(0, 4 - i) + o : o.substr(0, 4)
                  )))
                )
                  return null;
                c.setFullYear(n);
            ...
            0 < (r = o.substr(u)).length && l.splice(s + 1, 0, r);
          }
          return c;
        },
        ...
        formatDate: function (e, t) {
          ...
          if (e instanceof Date) {
            for (s = t.length, i = 0; i < s; i++)
              "S" !== (o = t.charAt(i)) &&
                "\\" !== o &&
                (0 < i && "\\" === t.charAt(i - 1)
                  ? (a += o)
                  : ((r = this.parseFormat(o, e)),
                    i !== s - 1 &&
                      this.intParts.test(o) &&
                      "S" === t.charAt(i + 1) &&
                      ((n = parseInt(r) || 0),
                      (r += this.dateSettings.ordinal(n))),
                    (a += r)));
            return a;
          }
          return "";
  ...
  var t = {
    ...
    o = function () {
      var o = t.i18n[s],
        a = {
          days: o.dayOfWeek,
          daysShort: o.dayOfWeekShort,
          months: o.months,
          monthsShort: e.map(o.months, function (e) {
            return e.substring(0, 3);
          }),
        };
      "function" == typeof DateFormatter &&
        (i = n = new DateFormatter({ dateSettings: e.extend({}, r, a) }));
    },
    a = {
      moment: {
        default_options: {
      ...
      return this.each(function () {
        ...
        "hide" !== i
          ? (e(this).hasClass("xdsoft_scroller_box") ||
              ...
              o.append(a),
              l.addClass("xdsoft_scroller_box").append(o),
              (v = function (e) {
                var t = d(e).y - p + g;
                t < 0 && (t = 0),
                  t + a[0].offsetHeight > f && (t = f - a[0].offsetHeight),
              ...
              a
                .on(
                  ...
                  function (n) {
                    s || l.trigger("resize_scroll.xdsoft_scroller", [i]),
                      (p = d(n).y),
              ...
              l
                .on("scroll_element.xdsoft_scroller", function (e, t) {
                  s || l.trigger("resize_scroll.xdsoft_scroller", [t, !0]),
                  ...
                  (s = l[0].clientHeight),
                    ...
                    1 < d
                      ...
                      : (a.show(),
                        ...
                        (c = o[0].offsetHeight - a[0].offsetHeight),
                        !0 !== i &&
              ...
              l.on("mousewheel", function (e) {
                ...
                return (
                  (t -= 20 * e.deltaY) < 0 && (t = 0),
                  l.trigger("scroll_element.xdsoft_scroller", [t / (r - s)]),
                  e.stopPropagation(),
                  !1
                );
              }),
      ...
      return (
        (o = function (t) {
          var r,
            ...
            M,
            C,
            k = e('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
            D = e(
            ...
            F = 0;
          T.id && k.attr("id", T.id),
            T.style && k.attr("style", T.style),
            T.weeks && k.addClass("xdsoft_showweeks"),
            T.rtl && k.addClass("xdsoft_rtl"),
            k.addClass("xdsoft_" + T.theme),
            k.addClass(T.className),
            I.find(".xdsoft_month span").after(j),
            I.find(".xdsoft_year span").after(N),
              ...
              function (t) {
                ...
                for (
                  I.find(".xdsoft_select").hide(),
                    ...
                    n = 0;
                  n < i.length && i.eq(n).data("value") !== r;
                  n += 1
                )
                  o += i[0].offsetHeight;
                return (
                  s.xdsoftScroller(
                    T,
                    o / (s.children()[0].offsetHeight - s[0].clientHeight)
                  ),
                  t.stopPropagation(),
                  !1
                );
          ...
          var B = function (e) {
            ...
            Math.sqrt(n * n + s * s) > T.touchMovedThreshold &&
              (this.touchMoved = !0);
          };
          function Y() {
            var e,
            ...
            return (
              T.startDate
                ? (i = M.strToDate(T.startDate))
                : (i = T.value || (t && t.val && t.val() ? t.val() : ""))
                ? ((i = M.strToDateTime(i)),
                  T.yearOffset &&
                    (i = new Date(
                      i.getFullYear() - T.yearOffset,
                      i.getMonth(),
                      i.getDate(),
                      i.getHours(),
                      i.getMinutes(),
                ...
                : T.defaultDate &&
                  ((i = M.strToDateTime(T.defaultDate)),
                  T.defaultTime &&
                    ((e = M.strtotime(T.defaultTime)),
                    i.setHours(e.getHours()),
                    i.setMinutes(e.getMinutes()))),
              i && M.isValidDate(i) ? k.data("changed", !0) : (i = ""),
              i || 0
            );
          }
          function R(n) {
            ...
            n.mask && t.off("keydown.xdsoft"),
              ...
              "string" === e.type(n.mask) &&
                (s(n.mask, t.val()) ||
                  (t.val(n.mask.replace(/[0-9]/g, "_")), r(t[0], 0)),
                t.on("paste.xdsoft", function (i) {
                  ...
                  return (
                    (a = a.substr(0, l) + o + a.substr(l + o.length)),
                    (l += o.length),
                    s(n.mask, a)
                      ? ((this.value = a), r(this, l))
                      : "" === e.trim(a)
                ...
                t.on("keydown.xdsoft", function (i) {
                  ...
                  if (
                    ...
                    for (
                      ...
                      var C = n.mask.substr(c, 1),
                        k = c < n.mask.length,
                        D = 0 < c;
                      if (!(/[^0-9_]/.test(C) && k && D)) break;
                      c += 8 !== l || M ? 1 : -1;
                    }
                    if ((i.metaKey && (M = !(c = 0)), M)) {
                      var O = T - c,
                        I = n.mask.replace(/[0-9]/g, "_"),
                        L = I.substr(c, O).substr(1);
                      a = a.substr(0, c) + (o + L) + a.substr(c + O);
                    } else a = a.substr(0, c) + o + a.substr(c + 1);
                    if ("" === e.trim(a)) a = I;
                    ...
                    for (
                      ...
                      c += 8 === l ? 0 : 1;
                    s(n.mask, a)
                      ? ((this.value = a), r(this, c))
                      : "" === e.trim(a)
                      ? (this.value = n.mask.replace(/[0-9]/g, "_"))
                      : t.trigger("error_input.xdsoft");
                  } else if ((-1 !== [b, w, _, x, S].indexOf(l) && E) || -1 !== [p, f, g, h, m, y, d, v, u].indexOf(l)) return !0;
          ...
          I.find(".xdsoft_select")
            ...
            .on("touchmove", ".xdsoft_option", B)
            .on("touchend mousedown.xdsoft", ".xdsoft_option", function () {
              if (!this.touchMoved) {
                (void 0 !== M.currentTime && null !== M.currentTime) ||
                  (M.currentTime = M.now());
                ...
                M &&
                  ...
                  k.trigger("xchange.xdsoft"),
                  T.onChangeMonth &&
                    e.isFunction(T.onChangeMonth) &&
                    T.onChangeMonth.call(k, M.currentTime, k.data("input")),
                  t !== M.currentTime.getFullYear() &&
                    e.isFunction(T.onChangeYear) &&
                    T.onChangeYear.call(k, M.currentTime, k.data("input"));
              }
            }),
            (k.getValue = function () {
              return M.getCurrentTime();
            }),
            (k.setOptions = function (n) {
              var s = {};
              (T = e.extend(!0, {}, T, n)),
                n.allowTimes &&
                  e.isArray(n.allowTimes) &&
                  n.allowTimes.length &&
                  (T.allowTimes = e.extend(!0, [], n.allowTimes)),
                n.weekends &&
                  e.isArray(n.weekends) &&
                  n.weekends.length &&
                  (T.weekends = e.extend(!0, [], n.weekends)),
                n.allowDates &&
                  e.isArray(n.allowDates) &&
                  n.allowDates.length &&
                  (T.allowDates = e.extend(!0, [], n.allowDates)),
                n.allowDateRe &&
                  "[object String]" ===
                    Object.prototype.toString.call(n.allowDateRe) &&
                  (T.allowDateRe = new RegExp(n.allowDateRe)),
                n.highlightedDates &&
                  e.isArray(n.highlightedDates) &&
                  n.highlightedDates.length &&
                  (e.each(n.highlightedDates, function (t, n) {
                    var r,
                      o = e.map(n.split(","), e.trim),
                      a = new c(i.parseDate(o[0], T.formatDate), o[1], o[2]),
                      l = i.formatDate(a.date, T.formatDate);
                    void 0 !== s[l]
                      ? (r = s[l].desc) &&
                        r.length &&
                        a.desc &&
                  ...
                  (T.highlightedDates = e.extend(!0, [], s))),
                n.highlightedPeriods &&
                  e.isArray(n.highlightedPeriods) &&
                  n.highlightedPeriods.length &&
                  ((s = e.extend(!0, [], T.highlightedDates)),
                  e.each(n.highlightedPeriods, function (t, n) {
                    var r, o, a, l, d, u, p;
                    if (e.isArray(n))
                      (r = n[0]), (o = n[1]), (a = n[2]), (p = n[3]);
                    else {
                      var h = e.map(n.split(","), e.trim);
                      (r = i.parseDate(h[0], T.formatDate)),
                        (o = i.parseDate(h[1], T.formatDate)),
                        (a = h[2]),
                        (p = h[3]);
                    }
                    for (; r <= o; )
                      (l = new c(r, a, p)),
                        (d = i.formatDate(r, T.formatDate)),
                ...
                n.disabledDates &&
                  ...
                  (T.disabledDates = e.extend(!0, [], n.disabledDates)),
                n.disabledWeekDays &&
                  e.isArray(n.disabledWeekDays) &&
                  n.disabledWeekDays.length &&
                  (T.disabledWeekDays = e.extend(!0, [], n.disabledWeekDays)),
                (!T.open && !T.opened) || T.inline || t.trigger("open.xdsoft"),
                T.inline &&
                  ((H = !0), k.addClass("xdsoft_inline"), t.after(k).hide()),
                T.inverseButton &&
                  ((T.next = "xdsoft_prev"), (T.prev = "xdsoft_next")),
                T.datepicker ? O.addClass("active") : O.removeClass("active"),
                T.timepicker ? A.addClass("active") : A.removeClass("active"),
                T.value &&
                  (M.setCurrentTime(T.value), t && t.val && t.val(M.str)),
                isNaN(T.dayOfWeekStart)
                  ? (T.dayOfWeekStart = 0)
                  : (T.dayOfWeekStart = parseInt(T.dayOfWeekStart, 10) % 7),
                T.timepickerScrollbar || P.xdsoftScroller(T, "hide"),
                T.minDate &&
                  /^[\+\-](.*)$/.test(T.minDate) &&
                  (T.minDate = i.formatDate(
                    M.strToDateTime(T.minDate),
                    T.formatDate
                  )),
                T.maxDate &&
                  /^[\+\-](.*)$/.test(T.maxDate) &&
                  (T.maxDate = i.formatDate(
                    M.strToDateTime(T.maxDate),
                    T.formatDate
                  )),
                T.minDateTime &&
                  /^\+(.*)$/.test(T.minDateTime) &&
                  (T.minDateTime = M.strToDateTime(T.minDateTime).dateFormat(
                    T.formatDate
                  )),
                T.maxDateTime &&
                  /^\+(.*)$/.test(T.maxDateTime) &&
                  (T.maxDateTime = M.strToDateTime(T.maxDateTime).dateFormat(
                    T.formatDate
                  )),
                W.toggle(T.showApplyButton),
                I.find(".xdsoft_today_button").css(
                  "visibility",
                  T.todayButton ? "visible" : "hidden"
                ),
                I.find("." + T.prev).css(
                  "visibility",
                  T.prevButton ? "visible" : "hidden"
                ),
                I.find("." + T.next).css(
                  "visibility",
                  T.nextButton ? "visible" : "hidden"
                ),
                R(T),
                T.validateOnBlur &&
                    ...
                    if (
                      ...
                      (!e.trim(e(this).val()).length ||
                        ("string" == typeof T.mask &&
                          e.trim(e(this).val()) ===
                            T.mask.replace(/[0-9]/g, "_")))
                    )
                      e(this).val(null), k.data("xdsoft_datetime").empty();
                    else {
                      var t = i.parseDate(e(this).val(), T.format);
                      if (t) e(this).val(i.formatDate(t, T.format));
                        ...
                        s < 60
                          ...
                          : e(this).val(i.formatDate(M.now(), T.format));
                      }
                      k.data("xdsoft_datetime").setCurrentTime(e(this).val());
                    }
                    k.trigger("changedatetime.xdsoft"),
                      k.trigger("close.xdsoft");
                  }),
                (T.dayOfWeekStartPrev =
                  0 === T.dayOfWeekStart ? 6 : T.dayOfWeekStart - 1),
                k.trigger("xchange.xdsoft").trigger("afterOpen.xdsoft");
            }),
            k
              .data("options", T)
              .on("touchstart mousedown.xdsoft", function (e) {
            ...
            P.append(z),
            P.xdsoftScroller(T),
            k.on("afterOpen.xdsoft", function () {
              P.xdsoftScroller(T);
            }),
            k.append(O).append(A),
            !0 !== T.withoutCopyright && k.append(D),
            O.append(I).append(L).append(W),
            T.insideParent ? e(t).parent().append(k) : e(T.parentID).append(k),
            (M = new (function () {
              var t = this;
              (t.now = function (e) {
                var i,
                ...
                return (
                  !e &&
                    T.defaultDate &&
                    ((i = t.strToDateTime(T.defaultDate)),
                ...
                (t.getWeekOfYear = function (t) {
                  if (T.onGetWeekOfYear && e.isFunction(T.onGetWeekOfYear)) {
                    var i = T.onGetWeekOfYear.call(k, t);
                ...
                (t.strToDateTime = function (e) {
                  ...
                  return e && e instanceof Date && t.isValidDate(e)
                    ? e
                    : ((r = /^([+-]{1})(.*)$/.exec(e)) &&
                        (r[2] = i.parseDate(r[2], T.formatDate)),
                      (s =
                        r && r[2]
                          ? ((n =
                              r[2].getTime() - 6e4 * r[2].getTimezoneOffset()),
                            new Date(
                              t.now(!0).getTime() + parseInt(r[1] + "1", 10) * n
                            ))
                          : e
                          ? i.parseDate(e, T.format)
                          : t.now()),
                ...
                (t.strToDate = function (e) {
                  ...
                  var n = e ? i.parseDate(e, T.formatDate) : t.now(!0);
                  return t.isValidDate(n) || (n = t.now(!0)), n;
                }),
                (t.strtotime = function (e) {
                  if (e && e instanceof Date && t.isValidDate(e)) return e;
                  var n = e ? i.parseDate(e, T.formatTime) : t.now(!0);
                  return t.isValidDate(n) || (n = t.now(!0)), n;
                }),
                (t.str = function () {
                  var e = T.format;
                  return (
                    T.yearOffset &&
                      (e = (e = e.replace(
                        "Y",
                        t.currentTime.getFullYear() + T.yearOffset
                      )).replace(
                        "y",
                        String(
                          t.currentTime.getFullYear() + T.yearOffset
            ...
            W.on("touchend click", function (e) {
              e.preventDefault(),
                k.data("changed", !0),
                M.setCurrentTime(Y()),
                t.val(M.str()),
            ...
            I.find(".xdsoft_today_button")
              .on("touchend mousedown.xdsoft", function () {
                k.data("changed", !0),
                  M.setCurrentTime(0, !0),
                  k.trigger("afterOpen.xdsoft");
              })
            ...
            I.find(".xdsoft_prev,.xdsoft_next").on(
              ...
              function () {
                ...
                !(function e(s) {
                  t.hasClass(T.next)
                    ? M.nextMonth()
                    : t.hasClass(T.prev) && M.prevMonth(),
                    T.monthChangeSpinner &&
                  ...
                  e([T.ownerDocument.body, T.contentWindow]).on(
                    ...
                    function t() {
                      clearTimeout(i),
                        (n = !0),
                        e([T.ownerDocument.body, T.contentWindow]).off(
                          "touchend mouseup.xdsoft",
                          t
                        );
                    }
            ...
            A.find(".xdsoft_prev,.xdsoft_next").on(
              "touchend mousedown.xdsoft",
              function () {
                var t = e(this),
                  i = 0,
                  ...
                  s = 110;
                !(function e(r) {
                  var o = P[0].clientHeight,
                    a = z[0].offsetHeight,
                    l = Math.abs(parseInt(z.css("marginTop"), 10));
                  t.hasClass(T.next) && a - o - T.timeHeightInTimePicker >= l
                    ? z.css(
                        "marginTop",
                        "-" + (l + T.timeHeightInTimePicker) + "px"
                      )
                    : t.hasClass(T.prev) &&
                      0 <= l - T.timeHeightInTimePicker &&
                      z.css(
                        "marginTop",
                        "-" + (l - T.timeHeightInTimePicker) + "px"
                      ),
                    P.trigger("scroll_element.xdsoft_scroller", [
                      Math.abs(parseInt(z[0].style.marginTop, 10) / (a - o)),
                    ]),
                    (s = 10 < s ? 10 : s - 10),
                    n || (i = setTimeout(e, r || s));
                })(500),
                  e([T.ownerDocument.body, T.contentWindow]).on(
                    "touchend mouseup.xdsoft",
                    function t() {
            ...
            k
                ...
                clearTimeout(r),
                  (r = setTimeout(function () {
                    ...
                    for (
                      ...
                      m +=
                        "<th>" +
                        T.i18n[s].dayOfWeekShort[(r + T.dayOfWeekStart) % 7] +
                        "</th>";
                    for (
                      m += "</tr></thead>",
                        m += "<tbody>",
                        !1 !== T.maxDate &&
                          ((b = M.strToDate(T.maxDate)),
                          (b = new Date(
                            b.getFullYear(),
                            b.getMonth(),
                            b.getDate(),
                        ...
                        !1 !== x &&
                          (f =
                            ...
                            x.getDate());
                      v < M.currentTime.countDaysInMonth() ||
                      g.getDay() !== T.dayOfWeekStart ||
                      M.currentTime.getMonth() === g.getMonth();
                      ...
                      (S = []),
                        ...
                        S.push("xdsoft_date"),
                        (u =
                          T.beforeShowDay && e.isFunction(T.beforeShowDay.call)
                            ? T.beforeShowDay.call(k, g)
                            : null),
                        T.allowDateRe &&
                          "[object RegExp]" ===
                            Object.prototype.toString.call(T.allowDateRe) &&
                          (T.allowDateRe.test(i.formatDate(g, T.formatDate)) ||
                            S.push("xdsoft_disabled")),
                        T.allowDates &&
                          0 < T.allowDates.length &&
                          -1 ===
                            T.allowDates.indexOf(
                              i.formatDate(g, T.formatDate)
                            ) &&
                          S.push("xdsoft_disabled");
                      var D =
                      ...
                      ((!1 !== b && b < g) ||
                        ...
                        S.push("xdsoft_disabled"),
                        -1 !==
                          T.disabledDates.indexOf(
                            i.formatDate(g, T.formatDate)
                          ) && S.push("xdsoft_disabled"),
                        -1 !== T.disabledWeekDays.indexOf(a) &&
                          S.push("xdsoft_disabled"),
                        t.is("[disabled]") && S.push("xdsoft_disabled"),
                        u && "" !== u[1] && S.push(u[1]),
                        M.currentTime.getMonth() !== W &&
                          S.push("xdsoft_other_month"),
                        (T.defaultSelect || k.data("changed")) &&
                          i.formatDate(M.currentTime, T.formatDate) ===
                            i.formatDate(g, T.formatDate) &&
                          S.push("xdsoft_current"),
                        i.formatDate(y, T.formatDate) ===
                          i.formatDate(g, T.formatDate) &&
                          S.push("xdsoft_today"),
                        (0 !== g.getDay() &&
                          6 !== g.getDay() &&
                          ...
                          S.push("xdsoft_weekend"),
                        void 0 !==
                          T.highlightedDates[i.formatDate(g, T.formatDate)] &&
                          ((o =
                            T.highlightedDates[i.formatDate(g, T.formatDate)]),
                          S.push(
                            void 0 === o.style
                          ...
                          (h = void 0 === o.desc ? "" : o.desc)),
                        T.beforeShowDay &&
                          e.isFunction(T.beforeShowDay) &&
                          S.push(T.beforeShowDay(g)),
                        E &&
                          ((m += "<tr>"),
                          (E = !1),
                          T.weeks && (m += "<th>" + c + "</th>")),
                    ...
                    (m += "</tbody></table>"),
                      ...
                      I.find(".xdsoft_label span")
                        .eq(0)
                        .text(T.i18n[s].months[M.currentTime.getMonth()]),
                      I.find(".xdsoft_label span")
                        .eq(1)
                        .text(M.currentTime.getFullYear() + T.yearOffset),
                      (W = C = "");
                    var O = 0;
                    if (!1 !== T.minTime) {
                      var A = M.strtotime(T.minTime);
                      O = 60 * A.getHours() + A.getMinutes();
                    }
                    var P = 1440;
                    if (
                      (!1 !== T.maxTime &&
                        ((A = M.strtotime(T.maxTime)),
                        (P = 60 * A.getHours() + A.getMinutes())),
                      !1 !== T.minDateTime &&
                        ((A = M.strToDateTime(T.minDateTime)),
                        i.formatDate(M.currentTime, T.formatDate) ===
                          i.formatDate(A, T.formatDate)))
                    ) {
                      var W = 60 * A.getHours() + A.getMinutes();
                      O < W && (O = W);
                    }
                    if (
                      (!1 !== T.maxDateTime &&
                        ((A = M.strToDateTime(T.maxDateTime)),
                        i.formatDate(M.currentTime, T.formatDate) ===
                          i.formatDate(A, T.formatDate) &&
                          (W = 60 * A.getHours() + A.getMinutes()) < P &&
                          (P = W)),
                      (p = function (n, s) {
                        var r,
                          o = M.now(),
                          a =
                            ...
                            T.allowTimes.length;
                        o.setHours(n),
                          (n = parseInt(o.getHours(), 10)),
                          o.setMinutes(s),
                          (s = parseInt(o.getMinutes(), 10)),
                          (S = []);
                        var l = 60 * n + s;
                        (t.is("[disabled]") || P <= l || l < O) &&
                          S.push("xdsoft_disabled"),
                          (r = new Date(M.currentTime)).setHours(
                            parseInt(M.currentTime.getHours(), 10)
                          ),
                          a ||
                            r.setMinutes(
                              Math[T.roundTime](
                                M.currentTime.getMinutes() / T.step
                              ) * T.step
                            ),
                          (T.initTime ||
                            T.defaultSelect ||
                            k.data("changed")) &&
                            r.getHours() === parseInt(n, 10) &&
                            ((!a && 59 < T.step) ||
                              r.getMinutes() === parseInt(s, 10)) &&
                            (T.defaultSelect || k.data("changed")
                              ? S.push("xdsoft_current")
                              : T.initTime && S.push("xdsoft_init_time")),
                      ...
                      for (v = 0; v < T.allowTimes.length; v += 1)
                        p(
                          M.strtotime(T.allowTimes[v]).getHours(),
                          (W = M.strtotime(T.allowTimes[v]).getMinutes())
                        );
                    else
                      for (r = v = 0; v < (T.hours12 ? 12 : 24); v += 1)
                        for (r = 0; r < 60; r += T.step) {
                          var H = 60 * v + r;
                          H < O ||
                            P <= H ||
                            p(
                    ...
                    for (
                      z.html(C), n = "", v = parseInt(T.yearStart, 10);
                      v <= parseInt(T.yearEnd, 10);
                      v += 1
                    )
                      n +=
                        '<div class="xdsoft_option ' +
                        (M.currentTime.getFullYear() === v
                          ? "xdsoft_current"
                          : "") +
                        '" data-value="' +
                        v +
                        ...
                        "</div>";
                    for (
                      N.children().eq(0).html(n),
                        v = parseInt(T.monthStart, 10),
                        n = "";
                      v <= parseInt(T.monthEnd, 10);
                      v += 1
                    )
                      n +=
                        '<div class="xdsoft_option ' +
                        (M.currentTime.getMonth() === v
                          ? "xdsoft_current"
                          : "") +
                        '" data-value="' +
                        v +
                        ...
                        T.i18n[s].months[v] +
                        "</div>";
                    j.children().eq(0).html(n), e(k).trigger("generate.xdsoft");
                  }, 10)),
                  o.stopPropagation();
              })
              .on("afterOpen.xdsoft", function () {
                var e, t, i, n;
                T.timepicker &&
                  (z.find(".xdsoft_current").length
                    ? (e = ".xdsoft_current")
                    : z.find(".xdsoft_init_time").length &&
                      (e = ".xdsoft_init_time"),
                  e
                    ? ((t = P[0].clientHeight),
                      (i = z[0].offsetHeight) - t <
                        (n =
                          z.find(e).index() * T.timeHeightInTimePicker + 1) &&
                        (n = i - t),
                      P.trigger("scroll_element.xdsoft_scroller", [
                        parseInt(n, 10) / (i - t),
                      ]))
            ...
            (o = 0),
            L.on("touchend click.xdsoft", "td", function (i) {
              i.stopPropagation(), (o += 1);
              var n = e(this),
                s = M.currentTime;
              if (
                (null == s && ((M.currentTime = M.now()), (s = M.currentTime)),
              ...
              s.setDate(1),
                ...
                k.trigger("select.xdsoft", [s]),
                t.val(M.str()),
                T.onSelectDate &&
                  e.isFunction(T.onSelectDate) &&
                  T.onSelectDate.call(k, M.currentTime, k.data("input"), i),
                k.data("changed", !0),
                k.trigger("xchange.xdsoft"),
                k.trigger("changedatetime.xdsoft"),
                (1 < o ||
                  !0 === T.closeOnDateSelect ||
                  (!1 === T.closeOnDateSelect && !T.timepicker)) &&
                  !T.inline &&
                  k.trigger("close.xdsoft"),
                setTimeout(function () {
                  o = 0;
            ...
            z
              ...
              .on("touchend click.xdsoft", "div", function (t) {
                if (!this.touchMoved) {
                  ...
                  if (
                    (null == n &&
                      ((M.currentTime = M.now()), (n = M.currentTime)),
                    i.hasClass("xdsoft_disabled"))
                  )
                    return !1;
                  n.setHours(i.data("hour")),
                    n.setMinutes(i.data("minute")),
                    k.trigger("select.xdsoft", [n]),
                    k.data("input").val(M.str()),
                    T.onSelectTime &&
                      e.isFunction(T.onSelectTime) &&
                      T.onSelectTime.call(k, M.currentTime, k.data("input"), t),
                    k.data("changed", !0),
                    k.trigger("xchange.xdsoft"),
                    k.trigger("changedatetime.xdsoft"),
                    !0 !== T.inline &&
                      !0 === T.closeOnTimeSelect &&
                      k.trigger("close.xdsoft");
                }
              }),
            O.on("mousewheel.xdsoft", function (e) {
              return (
                !T.scrollMonth ||
                (e.deltaY < 0 ? M.nextMonth() : M.prevMonth(), !1)
              );
            }),
            t.on("mousewheel.xdsoft", function (e) {
              return (
                !T.scrollInput ||
                (!T.datepicker && T.timepicker
                  ? (0 <=
                      (a = z.find(".xdsoft_current").length
                        ? z.find(".xdsoft_current").eq(0).index()
                        : 0) +
                        e.deltaY &&
                      a + e.deltaY < z.children().length &&
                      (a += e.deltaY),
                    z.children().eq(a).length &&
                      z.children().eq(a).trigger("mousedown"),
                    !1)
                  : T.datepicker && !T.timepicker
                  ? (O.trigger(e, [e.deltaY, e.deltaX, e.deltaY]),
                    t.val && t.val(M.str()),
                    k.trigger("changedatetime.xdsoft"),
                    !1)
                  : void 0)
            ...
            k
              .on("changedatetime.xdsoft", function (t) {
                if (T.onChangeDateTime && e.isFunction(T.onChangeDateTime)) {
                  var i = k.data("input");
                  T.onChangeDateTime.call(k, M.currentTime, i, t),
                    delete T.value,
                    i.trigger("change");
                }
              })
              .on("generate.xdsoft", function () {
                T.onGenerate &&
                  e.isFunction(T.onGenerate) &&
                  T.onGenerate.call(k, M.currentTime, k.data("input")),
                  H && (k.trigger("afterOpen.xdsoft"), (H = !1));
              })
            ...
            (l = function () {
              var t, i, n, s, r, o, a, l, d, c, u, p, h;
              if (
                ((t = (l = k.data("input")).offset()),
                (i = l[0]),
                (c = "top"),
                (n = t.top + i.offsetHeight - 1),
                (s = t.left),
                (r = "absolute"),
                (d = e(T.contentWindow).width()),
                (p = e(T.contentWindow).height()),
                (h = e(T.contentWindow).scrollTop()),
                T.ownerDocument.documentElement.clientWidth - t.left <
                  O.parent().outerWidth(!0))
              ) {
                var f = O.parent().outerWidth(!0) - i.offsetWidth;
                s -= f;
              }
              "rtl" === l.parent().css("direction") &&
                (s -= k.outerWidth() - l.outerWidth()),
                T.fixed
                  ? ((n -= h),
                    (s -= e(T.contentWindow).scrollLeft()),
                    (r = "fixed"))
                  : ((a = !1),
                    C(i, function (e) {
                      return (
                    ...
                    a && !T.insideParent
                      ? ((r = "fixed"),
                        n + k.outerHeight() > p + h
                          ? ((c = "bottom"), (n = p + h - t.top))
                          : (n -= h))
                      : n + k[0].offsetHeight > p + h &&
                        (n = t.top - k[0].offsetHeight + 1),
                    n < 0 && (n = 0),
                ...
                (u = {
                  position: r,
                  left: T.insideParent ? i.offsetLeft : s,
                  top: "",
                  bottom: "",
                }),
                T.insideParent
                  ? (u[c] = i.offsetTop + i.offsetHeight)
                  : (u[c] = n),
                k.css(u);
            }),
            k
              .on("open.xdsoft", function (t) {
                var i = !0;
                T.onShow &&
                  e.isFunction(T.onShow) &&
                  (i = T.onShow.call(k, M.currentTime, k.data("input"), t)),
                  !1 !== i &&
                    (k.show(),
                    l(),
                    e(T.contentWindow)
              ...
              .on("close.xdsoft", function (t) {
                ...
                I.find(".xdsoft_month,.xdsoft_year")
                  ...
                  .hide(),
                  T.onClose &&
                    e.isFunction(T.onClose) &&
                    (i = T.onClose.call(k, M.currentTime, k.data("input"), t)),
                  !1 === i || T.opened || T.inline || k.hide(),
                  t.stopPropagation();
              })
              .on("toggle.xdsoft", function () {
                k.is(":visible")
                  ? k.trigger("close.xdsoft")
                  : k.trigger("open.xdsoft");
              })
              .data("input", t),
            (F = 0),
            k.data("xdsoft_datetime", M),
            k.setOptions(T),
            M.setCurrentTime(Y()),
            t
              .data("xdsoft_datetimepicker", k)
              .on(
              ...
              .on("keydown.xdsoft", function (t) {
                var i,
                  n = t.which;
                return -1 !== [u].indexOf(n) && T.enterLikeTab
                  ? ((i = e(
        ...
        (a = function (t) {
          ...
          i &&
            ...
            e(T.contentWindow).off("resize.xdsoft"),
            e([T.contentWindow, T.ownerDocument.body]).off(
            ...
            if ("string" === e.type(n))
              switch (n) {
                  ...
                  (this.value = this.defaultValue),
                    (this.value &&
                      s
                        ...
                        .isValidDate(i.parseDate(this.value, T.format))) ||
                      s.data("changed", !1),
                ...
                case "validate":
                  ...
                  break;
                default:
                  s[n] && e.isFunction(s[n]) && (l = s[n](r));
              }
            else s.setOptions(n);
            return 0;
          }
          "string" !== e.type(n) &&
            (!T.lazyInit || T.open || T.inline
              ? o(e(this))
              : (t = e(this)).on(
                  "open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart",
                  function e() {
...
!(function (e) {
  ...
  (function (e) {
    ...
    function l(n) {
      var s,
        ...
        m = 0;
      if (
        (((n = e.event.fix(o)).type = "mousewheel"),
        "detail" in o && (h = -1 * o.detail),
        "wheelDelta" in o && (h = o.wheelDelta),
        "wheelDeltaY" in o && (h = o.wheelDeltaY),
        "wheelDeltaX" in o && (p = -1 * o.wheelDeltaX),
        "axis" in o && o.axis === o.HORIZONTAL_AXIS && ((p = -1 * h), (h = 0)),
        (u = 0 === h ? p : h),
        "deltaY" in o && (u = h = -1 * o.deltaY),
        "deltaX" in o && ((p = o.deltaX), 0 === h && (u = -1 * p)),
        0 !== h || 0 !== p)
      ) {
        if (1 === o.deltaMode) {
  ...
  (function (e) {
    ...
    var t,
      ...
      _ = function (t, i, n, s) {
        ...
        return (
          (r.className = "mfp-" + t),
          n && (r.innerHTML = n),
          s ? i && i.appendChild(r) : ((r = e(r)), i && r.appendTo(i)),
          r
        );
      },
      x = function (i, n) {
      ...
      open: function (i) {
        ...
        if (!t.isOpen) {
          (t.types = []),
            ...
            t.bgOverlay ||
              ((t.bgOverlay = _("bg").on("click" + h, function () {
                t.close();
              })),
              (t.wrap = _("wrap")
                .attr("tabindex", -1)
    ...
    var T,
      ...
      k = "inline",
      D = function () {
        C && (M.after(C.addClass(T)).detach(), (C = null));
      };
        ...
        getInline: function (i, n) {
          if ((D(), i.src)) {
            ...
            if (r.length) {
              ...
              o &&
                o.tagName &&
                (M || ((T = s.hiddenClass), (M = _(T)), (T = "mfp-" + T)),
                (C = r.after(M).detach().removeClass(T))),
    ...
    e.magnificPopup.registerModule("image", {
      ...
      proto: {
        ...
        getImage: function (i, n) {
          ...
          return (
            t._parseMarkup(n, { title: z(i), img_replaceWith: i.img }, i),
            t.resizeImage(),
            i.hasSize
              ? (P && clearInterval(P),
                i.loadError
          ...
          return (
            ...
            !(!i || !i.enabled) &&
              ...
              w("UpdateStatus" + s, function (e, i) {
                i.text &&
                  (i.text = F(i.text, t.currItem.index, t.items.length));
              }),
              w(d + s, function (e, n, s, r) {
                var o = t.items.length;
                s.counter = o > 1 ? F(i.tCounter, r.index, o) : "";
              }),
...
var Swiper = (function () {
          ...
          void 0 !== r &&
            ...
            (d(e[n]) && d(s[n])
              ? s[n].__swiper__
                ...
                : c(e[n], s[n])
              : !d(e[n]) && d(s[n])
              ? ((e[n] = {}), s[n].__swiper__ ? (e[n] = s[n]) : c(e[n], s[n]))
              : (e[n] = s[n]));
        }
      }
    }
  ...
  function p(e) {
    ...
    const c = i > o ? "next" : "prev",
      ...
      p = () => {
        ...
        let c = o + r * (i - o);
        if ((u(c, i) && (c = i), t.wrapperEl.scrollTo({ [n]: c }), u(c, i)))
          return (
  ...
  function L(e) {
    ...
    let _ = !0;
    p.matches(o.focusableElements) &&
      ((_ = !1), "SELECT" === p.nodeName && (o.isTouched = !1)),
      i.activeElement &&
        i.activeElement.matches(o.focusableElements) &&
        i.activeElement !== p &&
        i.activeElement.blur();
    const x = _ && t.allowTouchMove && l.touchStartPreventDefault;
  ...
  function A(e) {
    const t = n(),
      i = this,
      s = i.touchEventsData,
      { params: r, touches: o, rtlTranslate: l, enabled: d } = i;
    if (!d) return;
    ...
    const u = s.evCache.findIndex((e) => e.pointerId === c.pointerId);
    u >= 0 && (s.evCache[u] = c);
    ...
    if (r.touchReleaseOnEdges && !r.loop)
      if (i.isVertical()) {
        if (
          (f < o.startY && i.translate <= i.maxTranslate()) ||
          (f > o.startY && i.translate >= i.minTranslate())
        )
    ...
    if (!s.isMoved) {
      if (
        (w && _ && i.loopFix({ direction: i.swipeDirection }),
      ...
      update: {
        updateSize: function () {
          ...
          (t =
            ...
            (0 === t && e.isHorizontal()) ||
              ...
              ((t =
                t -
                parseInt(v(n, "padding-left") || 0, 10) -
                parseInt(v(n, "padding-right") || 0, 10)),
              (i =
                i -
                parseInt(v(n, "padding-top") || 0, 10) -
                parseInt(v(n, "padding-bottom") || 0, 10)),
              Number.isNaN(t) && (t = 0),
              Number.isNaN(i) && (i = 0),
              Object.assign(e, {
                width: t,
        ...
        updateSlides: function () {
          ...
          for (let s = 0; s < h; s += 1) {
            ...
            if (
              ((D = 0),
              p[s] && (r = p[s]),
              k && e.grid.updateSlide(s, r, h, t),
              !p[s] || "none" !== v(r, "display"))
            ) {
              if ("auto" === n.slidesPerView) {
                ...
                if (
                  ...
                  D = e.isHorizontal() ? _(r, "width", !0) : _(r, "height", !0);
                else {
                  const e = i(o, "width"),
                    t = i(o, "padding-left"),
                    n = i(o, "padding-right"),
                ...
                (D = (o - (n.slidesPerView - 1) * E) / n.slidesPerView),
                  n.roundLengths && (D = Math.floor(D)),
                  p[s] && (p[s].style[t("width")] = D + "px");
              p[s] && (p[s].swiperSlideSize = D),
                y.push(D),
                n.centeredSlides
                  ? ((T = T + D / 2 + M / 2 + E),
                    0 === M && 0 !== s && (T = T - o / 2 - E),
          ...
          if (
            ...
            k && e.grid.updateWrapperSize(D, m, t),
            !n.centeredSlides)
          ) {
            const t = [];
            for (let i = 0; i < m.length; i += 1) {
              ...
              n.roundLengths && (s = Math.floor(s)),
                m[i] <= e.virtualSize - o && t.push(s);
            }
            (m = t),
              Math.floor(e.virtualSize - o) - Math.floor(m[m.length - 1]) > 1 &&
                m.push(e.virtualSize - o);
          }
          if (d && n.loop) {
            const t = y[0] + E;
            ...
            for (
              ...
              1 === n.slidesPerGroup && m.push(m[m.length - 1] + t),
          ...
          if (
            ...
            u(s, "--swiper-centered-offset-before", -m[0] + "px"),
              u(
                s,
        ...
        updateSlidesClasses: function () {
          const e = this,
            ...
            o = (e) => f(n, `.${i.slideClass}${e}, swiper-slide${e}`)[0];
          let a;
          if (
            (t.forEach((e) => {
              e.classList.remove(
        ...
        updateActiveIndex: function (e) {
          ...
          if ((l >= n.length && (l = n.length - 1), d === r))
            return (
          ...
          (u =
            ...
            (t.initialized || t.params.runCallbacksOnInit) &&
              (o !== u && t.emit("realIndexChange"), t.emit("slideChange"));
        },
      ...
      slide: {
        slideTo: function (e, t, i, n, s) {
          ...
          if (
            ...
            (h && -y === r.translate) || (!h && y === r.translate))
          )
            return (
            ...
            (s = parseInt(
              ...
              t.centeredSlides
                ? r < e.loopedSlides - n / 2 ||
                  ...
                  ? (e.loopFix(),
                    (r = e.getSlideIndex(
                      f(i, `${a}[data-swiper-slide-index="${s}"]`)[0]
                    )),
                    o(() => {
                      e.slideTo(r);
                    }))
      ...
      loop: {
        loopCreate: function (e) {
          ...
          !i.loop ||
            ...
            (f(n, `.${i.slideClass}, swiper-slide`).forEach((e, t) => {
        ...
        loopFix: function (e) {
          ...
          let _ = 0,
            x = 0;
          if (r < m) {
            _ = Math.max(m - r, h.slidesPerGroup);
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = L.bind(e)),
            ...
            (e.onClick = W.bind(e)),
            (e.onLoad = N.bind(e)),
            H || (t.addEventListener("touchstart", F), (H = !0)),
            B(e, "on");
        },
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const p = a.direction && a.direction !== n.direction,
            ...
            f = n.loop;
          p && i && e.changeDirection(), c(e.params, a);
  ...
  class $ {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: i } = this,
        n = y(f(t, `.${i.slideClass}, swiper-slide`)[0]);
      return y(e) - n;
    }
      ...
      return (
        ...
        Object.assign(t, {
          ...
          rtlTranslate:
            ...
            ("rtl" === i.dir.toLowerCase() || "rtl" === v(i, "direction")),
    ...
    return (
      e.params.createElements &&
        Object.keys(n).forEach((s) => {
          if (!i[s] && !0 === i.auto) {
            let r = f(e.el, "." + n[s])[0];
            r || ((r = m("div", n[s])), (r.className = n[s]), e.el.append(r)),
              (i[s] = r),
              (t[s] = r);
          }
        }),
  ...
  function Z(e) {
    ...
    if ("object" == typeof e && "length" in e) {
      for (let i = 0; i < e.length; i += 1)
        (r = e[i]), t.slides[r] && t.slides[r].remove(), r < o && (o -= 1);
      o = Math.max(o, 0);
    } else
      (r = e),
  ...
  function se(e, t, i) {
    ...
    return r || ((r = m("div", n.split(" "))), s.append(r)), r;
  }
  ...
  const re = [
    function (e) {
      let t,
        { swiper: i, extendParams: s, on: r, emit: o } = e;
      s({
        virtual: {
          enabled: !1,
          slides: [],
      ...
      function c(e) {
        const {
          ...
          { addSlidesBefore: a, addSlidesAfter: l } = i.params.virtual,
          { from: c, to: u, slides: p, slidesGrid: h, offset: m } = i.virtual;
        i.params.cssMode || i.updateActiveIndex();
        const g = i.activeIndex || 0;
        let v, y, b;
        (v = i.rtlTranslate ? "right" : i.isHorizontal() ? "left" : "top"),
          s
            ? ((y = Math.floor(t / 2) + n + l), (b = Math.floor(t / 2) + n + a))
            : ((y = t + (n - 1) + l), (b = (r ? t : n) + a));
        let w = g - b,
          _ = g + y;
        r || ((w = Math.max(w, 0)), (_ = Math.min(_, p.length - 1)));
        let x = (i.slidesGrid[w] || 0) - (i.slidesGrid[0] || 0);
        function S() {
          i.updateSlides(),
            i.updateProgress(),
            i.updateSlidesClasses(),
        ...
        if (
          (r && g >= b
            ? ((w -= b), s || (x += i.slidesGrid[0]))
            : r && g < b && ((w = -b), s && (x += i.slidesGrid[0])),
        ...
        if (i.params.virtual.renderExternal)
          return (
            i.params.virtual.renderExternal.call(i, {
              ...
              slides: (function () {
                const e = [];
                for (let t = w; t <= _; t += 1) e.push(p[t]);
                return e;
              })(),
            }),
        ...
        const C = r ? -p.length : 0,
          k = r ? 2 * p.length : p.length;
        for (let t = C; t < k; t += 1)
          if (t >= w && t <= _) {
            const i = M(t);
            void 0 === u || e
              ? T.push(i)
              : (t > u && T.push(i), t < c && E.push(i));
          }
        if (
          (T.forEach((e) => {
            i.slidesEl.append(d(p[e], e));
          }),
          r)
        )
          for (let e = E.length - 1; e >= 0; e -= 1) {
            const t = E[e];
            i.slidesEl.prepend(d(p[t], t));
          }
        else
          E.sort((e, t) => t - e),
            E.forEach((e) => {
              i.slidesEl.prepend(d(p[e], e));
            });
      ...
      r("beforeInit", () => {
        ...
        r("init update resize", () => {
          i.params.virtual.enabled &&
            i.params.cssMode &&
            u(i.wrapperEl, "--swiper-virtual-size", i.virtualSize + "px");
        }),
        Object.assign(i.virtual, {
    ...
    function (e) {
      ...
      function c() {
        t.keyboard.enabled ||
          (a.addEventListener("keydown", d), (t.keyboard.enabled = !0));
      }
      function u() {
        t.keyboard.enabled &&
          (a.removeEventListener("keydown", d), (t.keyboard.enabled = !1));
      }
      ...
      function m(e) {
        return !(
          ...
          (t.params.mousewheel.thresholdTime &&
            a() - u < t.params.mousewheel.thresholdTime) ||
          (!(e.delta >= 6 && a() - u < 60) &&
            (e.direction < 0
    ...
    function (e) {
      ...
      function u() {
        ...
        Object.assign(t.navigation, { nextEl: i, prevEl: n }),
          ...
          (n = r(n));
        const s = (i, n) => {
          i && i.addEventListener("click", "next" === n ? c : d),
    ...
    function (e) {
      ...
      function u(e) {
        ...
        if (t.params.loop) {
          ...
          if (i > t.slides.length - t.loopedSlides) r(i > s ? "next" : "prev");
      ...
      function p() {
        ...
        if (
          ...
          if (
            (i.dynamicBullets &&
              ((o = _(s[0], t.isHorizontal() ? "width" : "height", !0)),
              u.forEach((e) => {
        ...
        u.forEach((e, r) => {
          if (
            ("fraction" === i.type &&
              (e.querySelectorAll(U(i.currentClass)).forEach((e) => {
            ...
            "horizontal" === s ? (o = r) : (a = r),
              e.querySelectorAll(U(i.progressbarFillClass)).forEach((e) => {
            ...
            "custom" !== e.type && (i.innerHTML = r || ""),
              "bullets" === e.type &&
                t.pagination.bullets.push(
                  ...i.querySelectorAll(U(e.bulletClass))
                );
          }),
          "custom" !== e.type && s("paginationRender", n[0]);
      }
      function f() {
        t.params.pagination = X(
          t,
        ...
        "string" == typeof e.el &&
          ...
          i &&
            ...
            (t.params.uniqueNavElements &&
              ...
              i.length > 1 &&
                (i = i.filter((e) => b(e, ".swiper")[0] === t.el)[0])),
    ...
    function (e) {
      ...
      function y() {
        ...
        (i.style.width = ""),
          (i.style.height = ""),
          (c = t.isHorizontal() ? n.offsetWidth : n.offsetHeight),
          (u =
            t.size /
            (t.virtualSize +
      ...
      function T() {
        ...
        "string" == typeof n.el &&
          ...
          s &&
            ((r = s.querySelector("." + t.params.scrollbar.dragClass)),
            r || ((r = m("div", t.params.scrollbar.dragClass)), s.append(r))),
          Object.assign(e, { el: s, dragEl: r }),
          n.draggable && t.params.scrollbar.el && t.scrollbar.el && E("on"),
          s &&
    ...
    function (e) {
      ...
      const s =
        ...
        r = (e, i) => {
          ...
          if (
            ...
            (o =
              o.indexOf("%") >= 0
                ...
                : o * i * s + "px"),
            (a =
              a.indexOf("%") >= 0 ? parseInt(a, 10) * i + "%" : a * i + "px"),
            null != d)
          ) {
          ...
          null != l && (u += ` scale(${l - (l - 1) * (1 - Math.abs(i))})`),
            c && null != c && (u += ` rotate(${c * i * -1}deg)`),
            (e.style.transform = u);
        },
        o = () => {
          const {
            ...
            l = f(e, s);
          t.isElement && l.push(...f(t.hostEl, s)),
            l.forEach((e) => {
              r(e, n);
            }),
            i.forEach((e, i) => {
    ...
    function (e) {
      ...
      function x(e) {
        if (("mouse" === e.pointerType && p.splice(0, p.length), !_(e))) return;
        const i = t.params.zoom;
        if (((a = !1), (d = !1), p.push(e), !(p.length < 2))) {
          if (((a = !0), (h.scaleStart = w()), !h.slideEl)) {
            ...
            if (
              ...
              (h.imageEl = n),
              (h.imageWrapEl = n
                ? b(h.imageEl, "." + i.containerClass)[0]
                : void 0),
              !h.imageWrapEl)
            )
              return void (h.imageEl = void 0);
            h.maxRatio =
              h.imageWrapEl.getAttribute("data-swiper-zoom") || i.maxRatio;
          }
          if (h.imageEl) {
            const [e, t] = (function () {
              ...
              return [
                (p[0].pageX + (p[1].pageX - p[0].pageX) / 2 - e.x - o.scrollX) /
                  c,
                (p[0].pageY + (p[1].pageY - p[0].pageY) / 2 - e.y - o.scrollY) /
                  c,
              ];
            })();
            (h.originX = e),
      ...
      function S(e) {
        ...
        s >= 0 && (p[s] = e),
          p.length < 2 ||
            ...
            (h.scaleMove = w()),
            h.imageEl &&
              ((n.scale = (h.scaleMove / h.scaleStart) * c),
              n.scale > h.maxRatio &&
                (n.scale = h.maxRatio - 1 + (n.scale - h.maxRatio + 1) ** 0.5),
              n.scale < i.minRatio &&
      ...
      function E(e) {
        ...
        s >= 0 && p.splice(s, 1),
          a &&
            ...
            (d = !1),
            h.imageEl &&
              ((n.scale = Math.max(Math.min(n.scale, h.maxRatio), i.minRatio)),
      ...
      function T(e) {
        ...
        const n = m.width * i.scale,
          s = m.height * i.scale;
        if (n < h.slideWidth && s < h.slideHeight) return;
        if (
        ...
        e.cancelable && e.preventDefault(),
          e.stopPropagation(),
          (m.isMoved = !0);
        const r = (i.scale - c) / (h.maxRatio - t.params.zoom.minRatio),
          { originX: o, originY: a } = h;
        (m.currentX =
          m.touchesCurrent.x -
          m.touchesStart.x +
          m.startX +
          ...
          (v.x =
            (m.touchesCurrent.x - v.prevPositionX) /
            (Date.now() - v.prevTime) /
            2),
          (v.y =
            (m.touchesCurrent.y - v.prevPositionY) /
            (Date.now() - v.prevTime) /
            2),
      ...
      function C(e) {
        ...
        if (!h.slideEl) {
          ...
          i &&
            ...
            (h.imageEl = i),
            (h.imageWrapEl = i
              ? b(h.imageEl, "." + n.containerClass)[0]
              : void 0);
        }
        if (!h.imageEl || !h.imageWrapEl) return;
        let s, r, a, l, d, u, p, v, y, w, _, x, S, E, T, M, C, k;
        t.params.cssMode &&
          ((t.wrapperEl.style.overflow = "hidden"),
          (t.wrapperEl.style.touchAction = "none")),
          h.slideEl.classList.add("" + n.zoomedSlideClass),
          void 0 === m.touchesStart.x && e
            ? ((s = e.pageX), (r = e.pageY))
            : ((s = m.touchesStart.x), (r = m.touchesStart.y));
        const D = "number" == typeof e ? e : null;
        1 === c && D && ((s = void 0), (r = void 0)),
          (i.scale =
            D || h.imageWrapEl.getAttribute("data-swiper-zoom") || n.maxRatio),
          (c =
            D || h.imageWrapEl.getAttribute("data-swiper-zoom") || n.maxRatio),
          !e || (1 === c && D)
            ? ((p = 0), (v = 0))
            : ((C = h.slideEl.offsetWidth),
              (k = h.slideEl.offsetHeight),
              (a = g(h.slideEl).left + o.scrollX),
              (l = g(h.slideEl).top + o.scrollY),
              (d = a + C / 2 - s),
              (u = l + k / 2 - r),
              ...
              (_ = y * i.scale),
              (x = w * i.scale),
              (S = Math.min(C / 2 - _ / 2, 0)),
              (E = Math.min(k / 2 - x / 2, 0)),
              (T = -S),
              (M = -E),
              (p = d * i.scale),
              (v = u * i.scale),
              ...
              v < E && (v = E),
              v > M && (v = M)),
          D && 1 === i.scale && ((h.originX = 0), (h.originY = 0)),
      ...
      function k() {
        ...
        if (!h.slideEl) {
          t.params.virtual && t.params.virtual.enabled && t.virtual
            ? (h.slideEl = f(t.slidesEl, "." + t.params.slideActiveClass)[0])
            : (h.slideEl = t.slides[t.activeIndex]);
      ...
      function I() {
        ...
        t.wrapperEl.addEventListener("pointerdown", x, i),
          t.wrapperEl.addEventListener("pointermove", S, n),
          ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            t.wrapperEl.addEventListener(e, E, i);
          }),
          t.wrapperEl.addEventListener("pointermove", T, n);
      }
      function L() {
        const e = t.zoom;
        if (!e.enabled) return;
        e.enabled = !1;
        const { passiveListener: i, activeListenerWithCapture: n } = O();
        t.wrapperEl.removeEventListener("pointerdown", x, i),
          t.wrapperEl.removeEventListener("pointermove", S, n),
          ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            t.wrapperEl.removeEventListener(e, E, i);
          }),
          t.wrapperEl.removeEventListener("pointermove", T, n);
      }
          ...
          t.zoom.enabled &&
            (function () {
              ...
              const s = v.x * i,
                ...
                o = v.y * n,
                a = m.currentY + o;
              0 !== v.x && (i = Math.abs((r - m.currentX) / v.x)),
                0 !== v.y && (n = Math.abs((a - m.currentY) / v.y));
    ...
    function (e) {
      ...
      function f(e) {
        ...
        (t.pagination &&
          ...
          !e.target.matches(U(t.params.pagination.bulletClass))) ||
          (t.navigation &&
            t.navigation.nextEl &&
          ...
          t.pagination &&
            n.matches(U(t.params.pagination.bulletClass)) &&
            n.click());
      }
      function g() {
        return (
      ...
      n("beforeInit", () => {
        (s = m("span", t.params.a11y.notificationClass)),
        ...
        n("afterInit", () => {
          t.params.a11y.enabled &&
            (() => {
              ...
              (p = o(p)),
                (h = o(h)),
                p && p.forEach((t) => b(t, r, e.nextSlideMessage)),
                h && h.forEach((t) => b(t, r, e.prevSlideMessage)),
                v() &&
        ...
        n("fromEdge toEdge afterInit lock unlock", () => {
          t.params.a11y.enabled &&
            (function () {
              ...
              const { nextEl: e, prevEl: i } = t.navigation;
              i && (t.isBeginning ? (p(i), l(i)) : (h(i), a(i))),
                e && (t.isEnd ? (p(e), l(e)) : (h(e), a(e)));
            })();
        }),
        n("paginationUpdate", () => {
          t.params.a11y.enabled &&
              ...
              g() &&
                t.pagination.bullets.forEach((i) => {
                  t.params.pagination.clickable &&
                    ...
                    i.matches(U(t.params.pagination.bulletActiveClass))
    ...
    function (e) {
      ...
      const a = (e) =>
        ...
        d = (e, i) => {
          ...
          const l = t.slides[i];
          let d = a(l.getAttribute("data-history"));
      ...
      const c = () => {
        ...
        u = () => {
          ...
          d.history.replaceState
            ? (d.history.replaceState(null, null, "#" + i || ""), s("hashSet"))
    ...
    function (e) {
      let t,
        i,
        { swiper: s, extendParams: r, on: o, emit: a, params: l } = e;
      ...
      const w = () => {
        ...
        x = () => {
          (s.autoplay.running = !0), _(), a("autoplayStart");
        },
        S = () => {
        ...
        E = (e, i) => {
          ...
          if (((s.autoplay.paused = !0), i))
            return f && (d = s.params.autoplay.delay), (f = !1), void n();
          const r = d || s.params.autoplay.delay;
          (d = r - (new Date().getTime() - y)),
            (s.isEnd && d < 0 && !s.params.loop) || (d < 0 && (d = 0), n());
        },
        T = () => {
        ...
        o("touchEnd", () => {
          if (!s.destroyed && s.autoplay.running && u) {
            if (
              ...
              return (p = !1), void (u = !1);
            p && s.params.cssMode && T(), (p = !1), (u = !1);
          }
        }),
        o("slideChange", () => {
          !s.destroyed && s.autoplay.running && (f = !0);
        }),
        Object.assign(s.autoplay, { start: x, stop: S, pause: E, resume: T });
    },
    function (e) {
          ...
          freeMode: {
            ...
            onTouchEnd: function (e) {
              ...
              if (i < -t.minTranslate()) t.slideTo(t.activeIndex);
                  ...
                  if (c.velocities.length > 1) {
                    ...
                    (t.velocity = n / s),
                      ...
                      Math.abs(t.velocity) < r.freeMode.minimumVelocity &&
                        (t.velocity = 0),
                      (s > 150 || a() - e.time > 300) && (t.velocity = 0);
                  } else t.velocity = 0;
                ...
                (!r.freeMode.momentum || u >= r.longSwipesMs) &&
                  (t.updateProgress(),
                  t.updateActiveIndex(),
                  t.updateSlidesClasses());
              }
        ...
        (r.grid = {
          ...
          updateSlide: (e, s, o, a) => {
            const { slidesPerGroup: d } = r.params,
              c = l(),
              { rows: u, fill: p } = r.params.grid;
            let h, f, m;
            if ("row" === p && d > 1) {
              const i = Math.floor(e / (d * u)),
                n = e - u * d * i,
                r = 0 === i ? d : Math.min(Math.ceil((o - i * u * d) / u), d);
              (m = Math.floor(n / r)),
                (f = n - m * r + i * d),
                (h = f + (m * t) / u),
                (s.style.order = h);
            ...
            (s.row = m),
              (s.column = f),
              (s.style[a("margin-top")] = 0 !== m ? c && c + "px" : "");
          },
          updateWrapperSize: (e, i, n) => {
            const { centeredSlides: s, roundLengths: o } = r.params,
              a = l(),
              { rows: d } = r.params.grid;
            if (
              ((r.virtualSize = (e + a) * t),
              (r.virtualSize = Math.ceil(r.virtualSize / d) - a),
              (r.wrapperEl.style[n("width")] = r.virtualSize + a + "px"),
              s)
            ) {
              const e = [];
          ...
          c.shadow &&
            (u
              ? ((h = t.wrapperEl.querySelector(".swiper-cube-shadow")),
                h ||
                  ((h = m("div", "swiper-cube-shadow")), t.wrapperEl.append(h)),
                (h.style.height = r + "px"))
          ...
          if (
            ...
            if (u)
              ...
              const e = Math.abs(f) - 90 * Math.floor(Math.abs(f) / 90),
                ...
                n = c.shadowScale / t,
                s = c.shadowOffset;
              h.style.transform = `scale3d(${i}, 1, ${n}) translate3d(0px, ${
                o / 2 + s
              }px, ${-o / 2 / n}px) rotateX(-90deg)`;
            }
          const g =
            (d.isSafari || d.isWebView) && d.needPerspectiveFix ? -l / 2 : 0;
          (i.style.transform = `translate3d(0px,0,${g}px) rotateX(${
            t.isHorizontal() ? 0 : f
      ...
      const s = (e, i) => {
        let n = t.isHorizontal()
          ...
          s = t.isHorizontal()
            ? e.querySelector(".swiper-slide-shadow-right")
            : e.querySelector(".swiper-slide-shadow-bottom");
        n || (n = se("flip", e, t.isHorizontal() ? "left" : "top")),
          s || (s = se("flip", e, t.isHorizontal() ? "right" : "bottom")),
      ...
      te({
        ...
        setTransition: (e) => {
          ...
          i.forEach((t) => {
            ...
            ne({ swiper: t, duration: e, transformElements: i });
        },
        recreateShadows: () => {
          t.params.flipEffect,
            t.slides.forEach((e) => {
          ...
          setTranslate: () => {
            ...
            for (let e = 0, t = n.length; e < t; e += 1) {
              ...
              if (
                ...
                e || (e = se("coverflow", t, o ? "left" : "top")),
                  i || (i = se("coverflow", t, o ? "right" : "bottom")),
                  e && (e.style.opacity = u > 0 ? u : 0),
                  i && (i.style.opacity = -u > 0 ? -u : 0);
              }
            }
          },
          setTransition: (e) => {
        ...
        setTranslate: () => {
          ...
          for (let i = 0; i < e.length; i += 1) {
            ...
            if ((f && m.shadow) || !f) {
              ...
              if ((!e && m.shadow && (e = se("creative", n)), e)) {
            ...
            (_.style.transform = w),
              (_.style.opacity = b),
              m.origin && (_.style.transformOrigin = m.origin);
          }
        },
        setTransition: (e) => {
          const i = t.slides.map((e) => h(e));
          i.forEach((t) => {
            ...
            ne({ swiper: t, duration: e, transformElements: i, allSlides: !0 });
        },
